$(function() {
    ...
    $($btn).one('click', (function(e) {
        ...
        e.preventDefault();
            ...
            'margin-left': '+=600'
            // fadeTo takes two arguments. The first will cause the element to  fade out over a period of 1500 milliseconds
            // or 1.5 seconds. The second is the opacity which is set to 50%
            $img.fadeTo(1500, 0.5);                
